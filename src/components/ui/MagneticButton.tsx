...
const PRIMARY =
  'text-white shadow-[0_2px_20px_rgba(139,92,246,0.2)] hover:shadow-[0_4px_36px_rgba(139,92,246,0.35)] hover:-translate-y-[2px] hover:[background-position:100%_50%] [transition:transform_200ms_var(--ease-snap),box-shadow_280ms_var(--ease-snap),background-position_400ms_var(--ease-snap)]';
